...
def merge_images(piece_folder, num_rows, num_cols, piece_size):
    ...
    finale_img = merged_image.resize((9600, 9600), resample=Image.LANCZOS)

    return finale_img


# Example usage:
piece_folder = "/home/kai/Desktop/predicted"
...
merged_image.save("/home/kai/Desktop/stitched/merged_image.png")
